...
class dtm_importar_empleados_v10(models.Model):
...
class res_company_bps(models.Model):
    _inherit = 'res.company'
    bps_id = fields.Char(string='Nro Bps')
